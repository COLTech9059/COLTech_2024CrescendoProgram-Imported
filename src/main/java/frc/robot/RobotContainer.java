...
public class RobotContainer {
    ...
    public RobotContainer()
    {
        ...
        rBumperO.onTrue(new ShootNote(m_Manipulator, Constants.supplyPosition, Constants.supplySpeed, 1, 2.5));
        // IO.commandController.b().onTrue(new ShuttleCommand(m_Manipulator, 0.4, 5));
