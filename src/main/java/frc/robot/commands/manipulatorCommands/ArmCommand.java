...
public class ArmCommand extends Command{
    ...
    public void execute()
    {
        ...
        //Backup incase the optic sensor is damaged. The method below is manual
        m_Manipulator.runIntake(canReverseIntake.getAsBoolean(), intakeActive.getAsBoolean(), true);
